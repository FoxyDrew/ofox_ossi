...
export OF_MAINTAINER=FoxyDrew

# Build environment stuffs
export FOX_BUILD_DEVICE="OnePlusOpen"
export ALLOW_MISSING_DEPENDENCIES=true
export FOX_USE_TWRP_RECOVERY_IMAGE_BUILDER=1
export TARGET_DEVICE_ALT="ossi, open"
export FOX_TARGET_DEVICES="ossi, open"
